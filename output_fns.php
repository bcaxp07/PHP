...
?>
  ...
  <head>
    ...
    <style>
      ...
      hr { color:blue; width:70%; text-align:center}
      a { color:blue; }
    </style>
  </head>
  <body>
  ...
  <tr>
  <td rowspan="2">
      <a href="index.php"><img src="images/logo.jpg" alt="Bongo Bike" border="0"
       align="left" valign="bottom" height="55" width="100"/></a>
      <p><a href ="index.php">Main Home Page</a></p>
  </td>
  <td rowspan="2">
      <a href="shopindex.php"><img src="images/logo.jpg" alt="Bongo Bike" border="0"
       align="left" valign="bottom" height="55" width="100"/></a>
      <p><a href ="shopindex.php">Shop Home Page</a></p>
  </td>
  ...
  if (!is_array($product_array)) {
    ...
    foreach ($product_array as $row) {
      ...
      if (@file_exists("images/".$row['productid'].".jpg")) {
        $title = "<img src=\"images/".$row['productid'].".jpg\"
  ...
  if (is_array($product)) {
    ...
    if (@file_exists("images/".$product['productid'].".jpg"))  {
      ...
      if(($size[0] > 0) && ($size[1] > 0)) {
        echo "<td><img src=\"images/".$product['isbn'].".jpg\"
...
function display_cart($cart, $change = true, $images = 1) {
  ...
  foreach ($cart as $productid => $qty)  {
    ...
    echo "<td align=\"left\">
          <a href=\"show_book.php?productid=".$productid."\">".$product['name']."</a>"
          ."</td>
...
?>
<br />
<a href="shopindex.php">Go to main site</a><br />
